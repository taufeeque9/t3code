...
describe("deriveLockedProvider", () => {
  ...
  it("keeps the lock on an instance the catalog no longer lists", () => {
    // Falling back to another driver would silently switch providers under a
