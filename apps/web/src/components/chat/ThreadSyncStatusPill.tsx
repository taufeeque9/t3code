...
export function ThreadSyncStatusPill({ phase }: { readonly phase: ThreadSyncPhase }) {
  ...
  return (
    <div
      aria-label={label}
      className="chat-composer-drawer-surface chat-composer-drawer-attached chat-composer-drawer-slot pointer-events-none flex max-w-[calc(48rem-2.75rem)] items-center gap-2 px-3 pt-2 pb-[calc(var(--chat-composer-attachment-overlap)_+_0.375rem)] text-foreground text-xs font-medium"
