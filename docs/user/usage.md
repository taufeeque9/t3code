...
cost. These estimates are not your subscription bill. Claude Code activity covers every configured
Claude provider instance, so accounts with their own home directories are all included.
